...
/**
* Tuskfish podcast display script.
* 
* User-facing controller script for presenting podcast content as collections of audio and
* video files.
*
 ...
 */
$content_handler = 'TfishPodcastHandler';
$index_template = 'podcasts';
$target_file_name = 'podcasts';

// Page title.
$tfish_template->page_title = TFISH_TYPE_PODCASTS;
