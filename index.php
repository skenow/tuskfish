...
$rss_url = !empty($clean_tag) ? TFISH_RSS_URL . '?tagId=' . $clean_tag : TFISH_RSS_URL;
...
// Otherwise retrieve an index page list of teasers.
    ...
    $tfTemplate->selectFilters = $tag_handler->getTagSelectBox($clean_tag);
