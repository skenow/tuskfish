...
// Otherwise retrieve an index page list of teasers.
    ...
    $tf_template->page_title = TFISH_LATEST_POSTS;
    ...
    $tf_template->select_action = 'index.php';
    $tag_handler = $content_handler_factory->getHandler('tag');
    $tf_template->select_filters = $tag_handler->getTagSelectBox($clean_tag);
    $tf_template->select_filters_form = $tf_template->render('select_filters');
}
