...
$criteria->add(new TfCriteriaItem($tfValidator, 'type', 'TfAudio'));

// Configure page.
$tfTemplate->pageTitle = TFISH_TYPE_AUDIO_FILES;
$indexTemplate = 'soundtracks';
$targetFileName = 'soundtracks';
