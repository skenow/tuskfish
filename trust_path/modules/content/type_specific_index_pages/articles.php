...
// Configure page.
$tfTemplate->pageTitle = TFISH_TYPE_ARTICLES;
$indexTemplate = 'articles';
$targetFileName = 'articles';
...
// View index page of multiple objects (teasers).
    ...
    $tfTemplate->selectFilters = $tagHandler->getTagSelectBox($cleanTag, 'TfArticle');
