...
/**
 * Tuskfish downloadablet object handler.
 * 
 * Provides download-specific handler methods.
 *
...
class TfishDownloadHandler extends TfishContentHandler
{
     ...
     * TfishDownloadHandler::getObjects($criteria) it is unecessary to set the object type.
