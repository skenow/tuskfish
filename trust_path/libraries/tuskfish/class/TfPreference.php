 ...
 * 
 * A preference object is automatically instantiated on every page via tf_header.php.
 *
 * @copyright   Simon Wilkinson 2013+ (https://tuskfish.biz)
 * @license     https://www.gnu.org/licenses/old-licenses/gpl-2.0.en.html GNU General Public License (GPL) V2
 * @author      Simon Wilkinson <simon@isengard.biz>
...
class TfPreference
{
    ...
    function __construct(TfValidator $tf_validator, array $tf_preferences)
    {
        $this->validator = $tf_validator;
        $this->loadPropertiesFromArray($tf_preferences);
    }
     ...
     * assigned to $tf_metadata instead, which will handle any escaping necessary.
     * 
