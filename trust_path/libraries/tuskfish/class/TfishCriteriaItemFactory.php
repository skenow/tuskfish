...
/**
 * TfishCriteriaItemFactory class file.
 * 
...
/**
 * Factory for instantiating TfishCriteriaItem objects and injecting dependencies.
 * 
 * Use this class to delegate construction of TfishCriteriaItem objects.
 * 
 ...
 */
class TfishCriteriaItemFactory
{
    protected $validator;
    ...
    {
        return new TfishCriteriaItem($this->validator, $column, $value, $operator);
    }
}
