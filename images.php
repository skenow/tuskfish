...
* 
* User-facing controller script for presenting image content. Use to generate image galleries or
* product catalogues. 
*
...
// Page title.
$tfish_template->page_title = '<i class="fa fa-file-image-o" aria-hidden="true"></i> ' . TFISH_TYPE_IMAGES;
