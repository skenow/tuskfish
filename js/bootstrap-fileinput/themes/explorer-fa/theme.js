...
(function ($) {
    ...
    $.fn.fileinputThemes['explorer-fa'] = {
        ...
        fileActionSettings: {
            ...
            dragIcon: '<i class="fas fa-arrows"></i>', // remove
        ...
        previewZoomButtonIcons: {
            ...
            toggleheader: '<i class="fas fa-arrows-v"></i>',
            fullscreen: '<i class="fas fa-arrows-alt"></i>',
            borderless: '<i class="fas fa-external-link"></i>',
            close: '<i class="fas fa-minus-circle"></i>'
        },
