...
if (in_array($op, array('edit', 'update', false))) {
    switch ($op) {
        ...
        case "edit":
            ...
            $tfish_template->preferences = TfishPreference::readPreferencesFromDatabase();
